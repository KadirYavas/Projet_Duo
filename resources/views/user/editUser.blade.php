...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Editer <b><i>{{$user->nom}}</i></b></li>
@endsection
...
@section('content')
    ...
    <form class="m-3" action="{{route('updateUser', $user->id)}}" method="post" enctype="multipart/form-data">
        ...
        <button class="btn btn-outline-danger text-dark font-weight-bold mt-5" type="submit">Sauvegarder les modifications</button>
    </form>
